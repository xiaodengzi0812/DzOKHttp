...
public class MultipartRequestBody implements RequestBody{
    ...
    public MultipartRequestBody setType(String type) {
        this.type = type;
        return this;
    }

    public MultipartRequestBody addFormDataPart(String key, String value) {
        params.put(key, value);
        return this;
    }

    public MultipartRequestBody addFormDataPart(String key, Binary binary) {
